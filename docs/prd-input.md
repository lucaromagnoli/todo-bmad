# Product Requirement Document (PRD) — Input

> Source PRD provided by stakeholder. This is the raw input that BMAD's PM persona will refine into a structured PRD in `docs/prd.md`.
